"""
URL configuration for product_import_engine project.
...
schema_view = get_schema_view(
    openapi.Info(
        title='Product Import Engine',
        default_version='v1',
        description="Product Import Engine API's",
    ),
    public=True,
...
urlpatterns = [
    ...
    path('api/imports/', include('imports.urls')), # app
